...
public class Constants {
	...
	// The following arrays transform this into corresponding dimensions (x,y) for
	// the resulting maze as well as the number of rooms and parts
	...
	public enum StateGUI {
		STATE_TITLE, STATE_GENERATING, STATE_PLAY, STATE_FINISH;
	}
