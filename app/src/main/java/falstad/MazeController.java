...
import sthomson.cs301.cs.wm.edu.amazebyseanthomson.ui.GeneratingActivity;
...
public class MazeController implements Order {
	...
	public void setPanel(MazePanel newPanel)
	{
		this.panel = newPanel;
	}
	...
	public void switchToPlayingScreen() {
		...
		addView(new FirstPersonDrawer(Constants.VIEW_WIDTH,Constants.VIEW_HEIGHT, Constants.MAP_UNIT,
				Constants.STEP_SIZE, seencells, mazeConfig.getRootnode(), getPanel())) ;
	...
	public enum UserInput {ReturnToTitle, Start, Up, Down, Left, Right, Jump, ToggleLocalMap, ToggleFullMap, ToggleSolution, ZoomIn, ZoomOut, Obstacle, ObstacleBackward, ObstacleLeft, ObstacleRight };
	/**
