...
public class Seg {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        case 0:
            ...
            //color[1] = RGB_DEF;
            //color[2] = RGB_DEF;
            color = Color.rgb(rgbValue, RGB_DEF, RGB_DEF);
            break;
        case 1:
            //color[0] = RGB_DEF;
            //color[1] = rgbValue;
            //color[2] = RGB_DEF;
            color = Color.rgb(RGB_DEF,rgbValue,RGB_DEF);
            break;
        case 2:
            //color[0] = RGB_DEF;
            //color[1] = RGB_DEF;
            //color[2] = rgbValue;
            color = Color.rgb(RGB_DEF,RGB_DEF,rgbValue);
            break;
        case 3:
            //color[0] = rgbValue;
            //color[1] = rgbValue;
            //color[2] = RGB_DEF;
            color = Color.rgb(rgbValue,rgbValue,RGB_DEF);
            break;
        case 4:
            //color[0] = RGB_DEF;
            //color[1] = rgbValue;
            //color[1] = rgbValue;
            color = Color.rgb(RGB_DEF,rgbValue,rgbValue);
            break;
        case 5:
            //color[0] = rgbValue;
            //color[1] = RGB_DEF;
            //color[2] = rgbValue;
            color = Color.rgb(rgbValue,RGB_DEF,rgbValue);
            break;
        default:
            //color[0] = RGB_DEF;
            //color[1] = RGB_DEF;
            //color[2] = RGB_DEF;
            color = Color.rgb(RGB_DEF,RGB_DEF,RGB_DEF);
            break;
        }
    }
